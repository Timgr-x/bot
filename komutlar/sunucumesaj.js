...
if(message.author.id !== ayarlar.sahip) return message.channel.send(":x: Bu komutu sadece sahibim kullanabilir.");
if(!args[0]){
        return message.channel.send(":x: Lütfen tüm sunuculara göndereceğim mesajı giriniz..")
        }
