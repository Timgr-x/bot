...
exports.run = (client, message, args) => {
  ...
  return message.channel.send(" Yetkin bulunmuyor.");
    message.channel.send(new Discord.RichEmbed().setColor('RED').setTitle('Komut girişi').setDescription('Gerekli Kanallar Kurulsun mu?.').setFooter('Bu eylemi onaylıyorsan "evet" yazman yeterlidir.Bu eylem 30 saniye içinde sona erecek'))
.then(() => {
...
.then((collected) => {
  ...
  message.guild.createChannel(`📚│kurallar`, 'text')
    ...
    .then(channel =>
      channel.setParent(message.guild.channels.find(channel => channel.name === "Önemli Kanallar")))
  ////////////////////////////////
 ...
 ////////////////////////////////////////
  ...
  /////////////////////////////////////////////
  message.guild.createChannel('Yetkili Kanallar', 'category', [{
       id: message.guild.id,
     }]);
   ...
   message.guild.createChannel(`🏆│Sohbet`, 'voice')
    ...
    .then(channel =>
      channel.setParent(message.guild.channels.find(channel => channel.name === "Yetkili Kanallar")))
  
  
  
  
   /////////////////////////////////////////////
  message.guild.createChannel('Şarkı Kanallar', 'category', [{
       id: message.guild.id,
     }]);
   ...
   message.guild.createChannel(`🎵│Music`, 'voice')
    ...
    .then(channel =>
      channel.setParent(message.guild.channels.find(channel => channel.name === "Şarkı Kanallar")))
